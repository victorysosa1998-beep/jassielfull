...
const API = {
  ...
  montessori: {
    categories:  ()      => API.get('/montessori/categories'),
    save:        d       => API.post('/montessori', d),
    submit:      id      => API.post(`/montessori/${id}/submit`),
    submitClass: d       => API.post('/montessori/submit-class', d),
    publish:     id      => API.post(`/montessori/${id}/publish`),
    lock:        id      => API.post(`/montessori/${id}/lock`),
    unlock:      id      => API.post(`/montessori/${id}/unlock`),
    list:        p       => API.get('/montessori', p),
    get:         id      => API.get(`/montessori/${id}`),
    myReports:   p       => API.get('/montessori/me/all', p),
    myUploads:   p       => API.get('/montessori/subadmin/uploads', p),
    pending:     p       => API.get('/montessori/pending', p),
    approve:     id      => API.post(`/montessori/${id}/approve`),
    reject:      (id,d)  => API.post(`/montessori/${id}/reject`, d),
    correction:  (id,d)  => API.post(`/montessori/${id}/correction`, d),
  },
  sessions: {
